...
import { A as AstroError, R as ResponseSentError } from './astro/assets-service_g-g3lz6v.mjs';
...
const onRequest$1 = defineMiddleware(async ({ cookies, url, redirect, locals }, next) => {
